...
public class MyArrayListTest {
    ...
    public static void main(String[] args) {
        ...
        // Integer - warp 클래스 int 기본 데이터 타입을 클래스로 설계해 둔 데이터 타입이다.

        // ArrayList<Integer> List -> 정수값을 하나의 변수에 저장하는 리스트 계열의 자료 구조를 생성
        ...
        // num 참조 변수에 list 참조 변수의 주소 값을 대입 시켰다.
        System.out.println("---------------------");
        ...
        nums.add(10);
        nums.add(500);
        // nums 라는 변수로 접근해서 add() 를 했는데 왜 다시 list 출력하면 데이터가 존재하고 있지?
        System.out.println("list : " + list);
