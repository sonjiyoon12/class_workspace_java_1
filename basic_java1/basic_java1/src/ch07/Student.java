...
public class Student {
    ...
    public void test(){
        System.out.println(studentName + " 가 시험을 친다");
    }

    // 2. 청소를 한다 메서드를 만들어 주세요

    public void clean() {
        System.out.println(studentName + " 가 청소를 한다");
    }

//    public String attack() {
//        if (studentId > 1) {
//            System.out.println(studentName + "가 처음입니다");
//            return
//        } else {
//            System.out.println(studentName + "가 다음입니다");
//        }
//    }
