...
public class AccountTest {
    ...
    public static void main(String[] args) {
        ...
        account.showInfo();
        // 실수 할 수 있는 가능성이 있다. !!
        // balance 변수를 외부에서 안보이게 접근 차단해 보자.
        // private 를 선언해서 외부에서 접근 차단

        // 외부에서는 오직 출금 기능, 입금 기능 멤서드로만 사용이 가능해 진다.

        // >>> 현재 잔액 <<<  <--- 출력하고 싶어.
        int outerBalancer = account.getBalance();
        System.out.println(">>>> 현재잔액 : " + outerBalancer + " <<<< ");
        // 자바에서 멤버 변수 값을 초기화 하지 않으면 String에서는 null 로 초기화 된다.
